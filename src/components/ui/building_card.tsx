    ...
    return(
        ...
        >
            <div className="relative w-full h-fit flex flex-row mb-1.5">
                ...
                <div className={`absolute right-0 top-0 rounded-full flex flex-row gap-x-3 w-fit h-fit p-2 bg-opacity-35 ${['bg-green-500', 'bg-yellow-500', 'bg-red-500'][building.crowd_level - 1]}`}>
                    <User size={icon_size}/>
                </div>
            </div>
